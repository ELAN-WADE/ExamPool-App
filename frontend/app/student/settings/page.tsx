      ...
      <div className="card" style={{ maxWidth: 520, marginBottom: "1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "1.1rem", marginBottom: "1.25rem" }}>
          ...
          <div>
            ...
            <span className="badge badge-info" style={{ marginTop: "0.35rem" }}>Student</span>
          </div>
        </div>
        ...
        <div style={{ borderTop: "1px solid var(--color-border)", paddingTop: "1rem" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.6rem", fontSize: "0.875rem" }}>
            ...
            {(user as any)?.grade && (
              <>
                <div style={{ color: "var(--color-muted)" }}>Class / Grade</div>
                <div style={{ fontWeight: 500 }}>{(user as any).grade}</div>
              </>
            )}
          </div>
        </div>
